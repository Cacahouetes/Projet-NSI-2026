...
Fonctionnalités :
  - 3 slots avec illustration + nom + rareté + prix
  - Slots vendus grisés avec overlay "VENDU"
  - Timer compte à rebours jusqu'au prochain restock
  - Popup de confirmation avant achat
  - Synchronisation complète avec la DB
"""
