...
chest_scene.py
==============
Scène d'ouverture de coffre — 3 phases :

  PHASE 1 : SELECT   — grille de 6 coffres (5 catégories + OMNI)
                        Tous identiques visuellement (mystère).
                        Affiche le prix + label catégorie.

  PHASE 2 : OPENING  — animation du coffre choisi (frames 1→6)
                        Flash coloré selon le type réel (NORMAL/GOD/DIVINE)
                        révélé UNIQUEMENT ici.

  PHASE 3 : REVEAL   — les 10 cartes arrivent une par une avec flip.
                        Chaque carte à > RARE fait un son + glow spécial.
                        Récap final : bouton "Tout vendre communes" + "Retour".
"""
...
class ChestScene(BaseScene):
    ...
    def __init__(self, manager):
        ...
        # Animation coffre (phase OPENING)
