...
Fonctionnalités :
  - Grille de cartes avec badge x2, x3... pour les doublons
  - Filtre par rareté (chips en haut)
  - Filtre par catégorie (chips en haut)
  - Tri : rareté, nom, quantité
  - Sélection multiple par clic (toggle)
  - Vente des cartes sélectionnées
  - Vente rapide de toute une rareté (bouton bas)
  - Scroll molette
"""
